      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-lg-12 text-center">
            <strong><h3>Dalam Proses</h3></strong>
          </div>
            ...
            <table class="table table-bordered">
              ...
              <tbody class="text-center">
               ...
               <tr>
                 ...
                 <td><?= $r->status;?></td>
                 <td><?php if($r->status == 'Menunggu Konfirmasi Alamat'){?>
                  <a href="<?= base_url().'product/ringkasan_pesanan/'.$r->id_transaksi;?>">Masukkan Alamat</a>
                  <?php }elseif($r->status == 'Menunggu Pembayaran'){?>

                    <a href="#edit_alamat" class="edit" data-id="<?= $r->id_transaksi;?>" >Ubah Alamat</a>
                  <?php }?>
                  </td>
               </tr>
               <?php }?>
